      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Chittaranjan Kakade</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <a href="mailto:chittaranjankakade@gmail.com">chittaranjankakade@gmail.com</a>
            </div>
            <Link
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            <Link
              href="/up coming.pdf"                                                                          //add your resume link here
              target="_blank"
              download
            >
            ...
            <Link
              href="https://github.com/chittaranjan16"                                                                     //add
              target="_blank"
            >
            ...
            <Link
              href="mailto:chittaranjankakade@gmail.com"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
            ...
            <Link
              href="https://x.com/"                                                                         //add your twitter link here
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
            ...
            <Link
              href="https://www.linkedin.com/in/chittaranjan-kakade-9a0b6b258?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"                                                    //add your linkedin link here
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
