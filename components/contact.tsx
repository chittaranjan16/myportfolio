            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Link
                    href="https://www.linkedin.com/in/chittaranjan-kakade-9a0b6b258?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                    target="_blank"
                    className="font-medium hover:underline"
                  >
                    linkedin.com/in/chittaranjan
                  </Link>
                </div>
              </div>
            </div>
